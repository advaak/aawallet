...
**AAwallet** (theaawallet.com) — a static publication of stock pitches and worked finance/consulting cases, written by two undergraduates. Two desks: **finance** and **consulting**. Every post carries a named byline; author pages are the URLs that go on resumes.
